...
- donner un nom au nouveau projet (par exemple `m2106_bd_agile_import`) et choisir le fichier d'export (https://gitlab-ce.iut.u-bordeaux.fr/Pierre/m2106_bd_agile/-/blob/master/2020-05-20_21-15-549_Pierre_m2106_bd_agile_export.tar.gz),
